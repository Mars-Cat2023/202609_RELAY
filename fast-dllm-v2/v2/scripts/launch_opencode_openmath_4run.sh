#!/usr/bin/env bash
# Submit the four 2-GPU OpenCode/OpenMath ablations concurrently.
#
...
if [ ! -d "${dataset_path}" ]; then
    ...
    echo "Run: python scripts/prep_opencode_openmath_mix.py" >&2
    exit 1
fi
...
echo "  MODEL_ROOT=output_models/opencode_openmath_60k_1p5B/vanilla_nopack2048_bs2x16x2_ep3_lr5e-6 \\"
echo "  USE_CARRY=0 sbatch train_scripts/submit_opencode_openmath_eval_sweep.sbatch"
