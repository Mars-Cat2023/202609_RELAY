#!/usr/bin/env bash
# Submit the four 2-GPU c40m60 ablations with decoder-aligned inner-block rollout.
#
# BPTT runs use BPTT_UNMASK_STRATEGY=decode_aligned and BPTT_INNER_BLOCK_SIZE=8.
# MAX_GRAD_NORM stays at the default 1.0 for this family.
#
...
recipe_tag=${RECIPE_TAG:-opencode_openmath_60k_c40m60_decodealigned8}
